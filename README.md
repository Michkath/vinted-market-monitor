# 🛍️ Strategic Pricing Monitor – Data Engineering Pipeline
...
Le projet alimente une table `vinted_raw` avec le schéma suivant :

```sql
CREATE TABLE vinted_raw (
...
*Projet réalisé dans le cadre d'un portfolio Data Engineering - 2025*
